    ...
    e.prototype = {
        ...
        getPagesTpl: function() {
            ...
            if (e >= b)
                ...
                d+='<a href="javascript:void(0);" class="ui-pagination-page-item ellipse" data-current="' + l + '">' + l + "</a>"
            }
            else {
                var t = ""
                for (g = Math.floor(f), h = c + g, i = c - g, j = 0 == e % 2, h > b && (j ? (i -= h - b - 1, h = b + 1) : (i -= h - b, h = b)), j || h++, k = i; h > k; k++){
					t +=
					k === c ?
                ...
                if (i>1) d+='<a href="javascript:void(0);" class="ui-pagination-page-item ellipse" data-current="' + l + '">' + l + "</a>"
                d += t
                if (h<=this.total) d+='<a href="javascript:void(0);" class="ui-pagination-page-item ellipse" data-current="' + l + '">' + l + "</a>"
            }
        ...
        eventBind: function() {
            ...
            this.ele.off("click").on("click", ".ui-pagination-page-item:not(.ellipse)", function() {
